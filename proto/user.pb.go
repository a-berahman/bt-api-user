...
func (*UserID) XXX_MessageName() string {
	return "user.UserID"
}
...
type User struct {
	...
	CreateDate           *time.Time `protobuf:"bytes,7,opt,name=create_date,json=createDate,proto3,stdtime" json:"create_date,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func init() {
	...
	golang_proto.RegisterType((*UserID)(nil), "user.UserID")
...
var fileDescriptor_116e343673f7ffaf = []byte{
	...
	,
}
...
func (*UnimplementedUserServiceServer) AddUser(ctx context.Context, req *User) (*UserID, error) {
